...
- **[Defragmentation](docs/etcd-defrag.md)** — the `EtcdDefrag` / `EtcdDefragPolicy` resources: reclaiming etcd backend disk, one-shot or on an operator-driven cron schedule, and its safety model.
