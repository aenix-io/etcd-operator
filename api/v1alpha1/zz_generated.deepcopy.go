...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UserManagedCertsSpec) DeepCopyInto(out *UserManagedCertsSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UserManagedCertsSpec.
func (in *UserManagedCertsSpec) DeepCopy() *UserManagedCertsSpec {
	if in == nil {
		return nil
	}
	out := new(UserManagedCertsSpec)
	in.DeepCopyInto(out)
	return out
}
